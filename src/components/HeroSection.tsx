...
const HeroSection: React.FC<HeroSectionProps> = ({ scrollToSection }) => {
  return (
    <section id="home" className="relative flex flex-col md:flex-row min-h-screen pt-16">
      <div className="w-full md:w-2/3 bg-gradient-accent flex items-center justify-center p-8 md:p-0 relative overflow-hidden">
        <div className="absolute inset-0 bg-gradient-to-r from-transparent to-surface-primary/20"></div>
        <img
      ...
      <div className="w-full md:w-1/3 bg-gradient-primary text-primary-foreground flex flex-col justify-end p-8 md:p-16 relative overflow-hidden">
        <div
        ...
        <div className="relative z-10 animate-fade-in-up">
          ...
          <h1 className="text-4xl md:text-5xl font-extrabold leading-tight mb-6 font-inter">
            ...
            <span className="bg-gradient-to-r from-brand-blue-light to-brand-blue bg-clip-text text-transparent"> zmieniają sposób</span>, 
