...
const CallToActionBar: React.FC<CallToActionBarProps> = ({ scrollToSection }) => {
  return (
    <section className="bg-gradient-primary text-primary-foreground py-16 px-6 md:px-12 flex flex-col md:flex-row items-center justify-between rounded-2xl shadow-large m-4 md:m-8 relative overflow-hidden">
      <div className="absolute inset-0 bg-gradient-to-r from-primary-light/20 to-transparent animate-pulse"></div>
      <div className="absolute inset-0 opacity-10">
        <div className="absolute top-0 left-0 w-40 h-40 bg-primary-foreground rounded-full blur-3xl"></div>
        <div className="absolute bottom-0 right-0 w-32 h-32 bg-brand-blue-light rounded-full blur-2xl"></div>
      </div>
